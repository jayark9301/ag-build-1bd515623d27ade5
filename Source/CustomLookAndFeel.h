...
public:
    VelvetLookAndFeel() {
        setColour(juce::Slider::thumbColourId,juce::Colour(0xfffb923c));
        setColour(juce::Slider::rotarySliderFillColourId,juce::Colour(0xfffb923c));
        ...
        setColour(juce::ResizableWindow::backgroundColourId,juce::Colour(0xff1a0f08));
    }
